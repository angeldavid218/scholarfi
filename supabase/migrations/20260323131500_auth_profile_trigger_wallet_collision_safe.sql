-- Make auth->profile trigger resilient when wallet metadata is duplicated.
-- Without this, GoTrue signup fails with "Database error saving new user"
-- because public.profiles.wallet_address is unique.
...
begin
  ...
  -- Keep signup robust: if the wallet is already linked, don't fail user creation.
